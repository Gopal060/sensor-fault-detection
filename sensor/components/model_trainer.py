...
class ModelTrainer:
    ...
    def perform_hyper_paramter_tunning(self):...
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            x_train, y_train, x_test, y_test = (
                train_arr[:, :-1], # Training input features
                train_arr[:, -1],  # Training target variable
                test_arr[:, :-1],  # Testing input features
                test_arr[:, -1],   # Testing target variable
            )
